use crate::bit::{Bit, Bit16, Bit2, Bit3};
...
pub(crate) fn mux8way16(inputs: [Bit16; 8], sel: Bit3) -> Bit16 {
    let t1 = mux16(inputs[0], inputs[4], sel[0]);
    let t2 = mux16(inputs[1], inputs[5], sel[0]);
    let t3 = mux16(inputs[2], inputs[6], sel[0]);
    let t4 = mux16(inputs[3], inputs[7], sel[0]);

    mux4way16([t1, t2, t3, t4], Bit2::from([sel[1], sel[2]]))
}
...
mod test {
    ...
    use crate::{bit16string, bit2string, bit3string, mux16test, mux4way16test, mux8way16test};
